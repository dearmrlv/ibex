...
class FlowConfig:
    ...
    def from_args(cls, args: argparse.Namespace) -> "FlowConfig":
        ...
        return cls(
            ...
            target_property_mode=args.target_property_mode,
    ...
    def from_state(cls, state: dict[str, Any]) -> "FlowConfig":
        ...
        config.setdefault("target_property_mode", "individual")
...
class FlowArgs:
    ...
    def arguments(self, argv: Sequence[str] | None = None) -> argparse.Namespace:
        ...
        parser.add_argument("--target-property-mode", choices=("merged", "individual"),
                            default="individual",
                            help="emit one merged property per RTL instance or one property per fire target")

...
analyze -sv12 \
  -f dut.f \
  -f env.f \
  -f /home/lvzhengyang/workspace/BSD-Cov/designs/ibex/dv/bsdcov2/bsdcov_run/bsdproj/results/traversal/ibex_wb_stage-0bb5b39547/ibex_wb_stage-0bb5b39547.traversal.f
...
clock clk_i
# reset ~rst_ni
set sim_fsdb [file normalize "/home/lvzhengyang/workspace/BSD-Cov/designs/ibex/dv/bsdcov2/eval/runs/run.20260610T115109Z.seed1/fsdb/eval.fsdb"]
...
save -jdb [file join "jgproject" "$trace_name.jdb"] -all -force
puts "INFO: saved Jasper DB = $save_dir"

...
class FSDBWrapper:
    ...
    @classmethod
    def from_simulation(cls, filepath: Path, verdi: Path = DEFAULT_VERDI) -> "FSDBWrapper":
        return cls(filepath, FSDBSource.SIM, verdi)
    ...
    def to_dict(self) -> dict[str, str]:
        return {"filepath": str(self.filepath), "source": self.source.value,

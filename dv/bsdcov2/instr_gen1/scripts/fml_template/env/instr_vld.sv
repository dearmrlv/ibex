module instr_vld #(
  ...
  parameter bit          PMP_EN = 1'b1,
  parameter bit          DBG_TRIGGER_EN = 1'b1,
  parameter bit          DEBUG_MODE = 1'b0,
  parameter bit          ALLOW_CSR_WRITES = 1'b0
) (
  ...
  function automatic logic csr_write_intent(input logic [31:0] instr);
    begin
      unique case (instr[14:12])
        3'b001, // csrrw
        3'b101: // csrrwi
        ...
        3'b110, // csrrsi
        3'b111: // csrrci
          csr_write_intent = (instr[19:15] != 5'b0);
  ...
  function automatic logic csr_addr_implemented(input logic [11:0] csr_addr);
    begin
      csr_addr_implemented = 1'b0;

      unique case (csr_addr)
        // Machine information and trap setup/handling.
        12'hf11, 12'hf12, 12'hf13, 12'hf14, 12'hf15,
        12'h300, 12'h301, 12'h304, 12'h305, 12'h306,
        12'h30a, 12'h310, 12'h31a,
        12'h340, 12'h341, 12'h342, 12'h343, 12'h344,

        // Machine counters and event selectors. Ibex treats unavailable
        // parameterized counters as implemented registers that read zero.
        12'h320,
        12'h323, 12'h324, 12'h325, 12'h326, 12'h327, 12'h328, 12'h329,
        12'h32a, 12'h32b, 12'h32c, 12'h32d, 12'h32e, 12'h32f,
        12'h330, 12'h331, 12'h332, 12'h333, 12'h334, 12'h335, 12'h336,
        12'h337, 12'h338, 12'h339, 12'h33a, 12'h33b, 12'h33c, 12'h33d,
        12'h33e, 12'h33f,
        12'hb00, 12'hb02,
        12'hb03, 12'hb04, 12'hb05, 12'hb06, 12'hb07, 12'hb08, 12'hb09,
        12'hb0a, 12'hb0b, 12'hb0c, 12'hb0d, 12'hb0e, 12'hb0f,
        12'hb10, 12'hb11, 12'hb12, 12'hb13, 12'hb14, 12'hb15, 12'hb16,
        12'hb17, 12'hb18, 12'hb19, 12'hb1a, 12'hb1b, 12'hb1c, 12'hb1d,
        12'hb1e, 12'hb1f,
        12'hb80, 12'hb82,
        12'hb83, 12'hb84, 12'hb85, 12'hb86, 12'hb87, 12'hb88, 12'hb89,
        12'hb8a, 12'hb8b, 12'hb8c, 12'hb8d, 12'hb8e, 12'hb8f,
        12'hb90, 12'hb91, 12'hb92, 12'hb93, 12'hb94, 12'hb95, 12'hb96,
        12'hb97, 12'hb98, 12'hb99, 12'hb9a, 12'hb9b, 12'hb9c, 12'hb9d,
        12'hb9e, 12'hb9f,

        // Custom machine-mode CSRs.
        12'h7c0, 12'h7c1:
          csr_addr_implemented = 1'b1;

        // PMP/ePMP registers exist only when PMP is enabled.
        ...
        12'h747, 12'h757:
          csr_addr_implemented = PMP_EN;

        // Trigger/context CSRs require trigger support but are accessible in
        // machine mode. Debug CSRs themselves require Debug Mode.
        12'h5a8, 12'h7a0, 12'h7a1, 12'h7a2, 12'h7a3, 12'h7a8, 12'h7aa:
          csr_addr_implemented = DBG_TRIGGER_EN;

        12'h7b0, 12'h7b1, 12'h7b2, 12'h7b3:
          csr_addr_implemented = DEBUG_MODE;
  ...
  function automatic logic csr_access_vld(input logic [31:0] instr);
    logic [11:0] csr_addr;
    logic        write_intent;
    logic        read_only;
    begin
      csr_addr = instr[31:20];
      write_intent = csr_write_intent(instr);

      // csr[11:10] == 2'b11 is architecturally read-only. mip is also
      // software read-only in Ibex even though its address is not in that range.
      read_only = (csr_addr[11:10] == 2'b11) || (csr_addr == 12'h344);
      // Keep CSR reads legal, but block CSR writes by default. Generated
      // CSR/PMP writes can change the execution environment (for example
      // mtvec, mstatus, PMP configuration, debug, counters), which makes a
      // CEX trace unsuitable as a normal software instruction sequence.
      csr_access_vld = csr_addr_implemented(csr_addr) &&
                       !(write_intent && read_only) &&
                       !(write_intent && !ALLOW_CSR_WRITES);
    end
  endfunction
    ...
    begin
      ...
      if (instr[14:12] == 3'b000) begin
        ...
        unique case (instr[14:12])
          ...
          3'b110,
          3'b111:
            system_vld = csr_access_vld(instr);

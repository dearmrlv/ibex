...
foreach p [get_property_list -include {type assert}] {
  if {[string match "*ibex_top.u_ibex_core.wb_stage_i.u_bsdcov_regions_ibex_wb_stage_9ea2ab83df.AST_BSDCOV_ibex_wb_stage_9ea2ab83df_R_unique_004*" $p]} {
...
# ----------------------------------------------------------------------
set max_traces_per_prop 1
set max_hunt_rounds     0
